...
SETFILE = 
NM = nm
BK_DEPS = /usr/local/wx2812/bk-deps
srcdir = .
top_srcdir = /usr/local/wx2812
LIBS = -lz -ldl -lm
LDFLAGS_GUI = 
CXX = g++
CXXFLAGS = -DWX_PRECOMP -pthread -Wall -Wundef -Wno-ctor-dtor-privacy -O2 -fno-strict-aliasing
CPPFLAGS = -D_FILE_OFFSET_BITS=64 -D_LARGE_FILES -I${wx_top_builddir}/lib/wx/include/gtk2-ansi-release-2.8 -I${top_srcdir}/include -pthread -I/usr/include/gtk-2.0 -I/usr/lib/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng14
...
EXTRALIBS = -pthread   -L/usr/X11R6/lib  -Wl,--version-script,$(wx_top_builddir)/version-script -lz -ldl -lm 
EXTRALIBS_GUI = -pthread -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lgdk_pixbuf-2.0 -lpango-1.0 -lfreetype -lfontconfig -lgobject-2.0 -lgthread-2.0 -lrt -lglib-2.0 -lXinerama -lXxf86vm -lSM -lpng -lz -ljpeg -ltiff
HOST_SUFFIX = 
SAMPLES_RPATH_FLAG = -Wl,-rpath,$(wx_top_builddir)/lib
SAMPLES_RPATH_POSTLINK = 
wx_top_builddir = /usr/local/wx2812
...
CIFRA_CXXFLAGS = -D__WX$(TOOLKIT)__ $(__WXUNIV_DEFINE_p) \
...
#EXTRALIBS_FOR_GUI = 
__cifra___mac_setfilecmd = @true
#__cifra___mac_setfilecmd = \
#	$(SETFILE) -a C cifra$(EXEEXT)
#__cifra___mac_rezcmd = $(__MACOSX_RESOURCES_p_1)
...
COND_PLATFORM_OS2_1___cifra___os2_emxbindcmd = $(NM) cifra$(EXEEXT) | if \
	grep -q pmwin.763 ; then emxbind -ep cifra$(EXEEXT) ; fi
#__cifra___os2_emxbindcmd = $(COND_PLATFORM_OS2_1___cifra___os2_emxbindcmd)
#__RCDEFDIR_p = -i \
...
#__cifra_app_Contents_PkgInfo___depname \
#	= cifra.app/Contents/PkgInfo
#__cifra_bundle___depname = cifra_bundle
#____cifra_BUNDLE_TGT_REF_DEP = \
#	$(__cifra_app_Contents_PkgInfo___depname)
#____cifra_BUNDLE_TGT_REF_DEP = \
#	$(__cifra_app_Contents_PkgInfo___depname)
...
#__cifra___win32rc = cifra_cifra_rc.o
...
COND_TOOLKIT_MAC___MACOSX_RESOURCES_p_1 = $(REZ) -d __DARWIN__ -t APPL -d \
	...
	cifra$(EXEEXT) Carbon.r sample.r
#__MACOSX_RESOURCES_p_1 = $(COND_TOOLKIT_MAC___MACOSX_RESOURCES_p_1)

### Targets: ###

all: cifra$(EXEEXT) $(__cifra_bundle___depname) #data
...
cifra$(EXEEXT): $(CIFRA_OBJECTS) $(__cifra___win32rc)
	$(CXX) -o $@ $(CIFRA_OBJECTS)    -L$(LIBDIRNAME) $(LDFLAGS_GUI) $(SAMPLES_RPATH_FLAG) $(LDFLAGS)  $(__WXLIB_MEDIA_p)  $(EXTRALIBS_MEDIA) $(__WXLIB_ADV_p) $(PLUGIN_ADV_EXTRALIBS) $(__WXLIB_HTML_p) $(EXTRALIBS_HTML) $(__WXLIB_XML_p) $(EXTRALIBS_XML) $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p) $(EXTRALIBS_FOR_GUI) $(__LIB_ZLIB_p) $(__LIB_ODBC_p) $(__LIB_REGEX_p) $(__LIB_EXPAT_p) $(EXTRALIBS_FOR_BASE) $(LIBS)
	$(__cifra___mac_rezcmd)
	$(__cifra___mac_setfilecmd)
	$(__cifra___os2_emxbindcmd)
	$(SAMPLES_RPATH_POSTLINK)

#cifra.app/Contents/PkgInfo: cifra$(EXEEXT) $(top_srcdir)/src/mac/carbon/Info.plist.in $(top_srcdir)/src/mac/carbon/wxmac.icns
#	mkdir -p cifra.app/Contents
#	mkdir -p cifra.app/Contents/MacOS
#	mkdir -p cifra.app/Contents/Resources
#	
#	
#	sed -e "s/IDENTIFIER/`echo $(srcdir) | sed -e 's,\.\./,,g' | sed -e 's,/,.,g'`/" \
#	-e "s/EXECUTABLE/cifra/" \
#	-e "s/VERSION/$(WX_VERSION)/" \
#	$(top_srcdir)/src/mac/carbon/Info.plist.in >cifra.app/Contents/Info.plist
#	
#	
#	echo -n "APPL????" >cifra.app/Contents/PkgInfo
#	
#	
#	ln -f cifra$(EXEEXT) cifra.app/Contents/MacOS/cifra
#	
#	
#	cp -f $(top_srcdir)/src/mac/carbon/wxmac.icns cifra.app/Contents/Resources/wxmac.icns

#cifra_bundle: $(____cifra_BUNDLE_TGT_REF_DEP)
...
cifra_cifra.o: $(srcdir)/cifra.cpp
	$(CXXC) -c -o $@ $(CIFRA_CXXFLAGS) $(srcdir)/cifra.cpp

cifra_cifra_rc.o: $(srcdir)/cifra.rc
...
.PHONY: all install uninstall clean distclean cifra_bundle data
